<template>
  <f7-page>
    <div class="search_box">
      ...
      <div @click="triger_search" class="search active">
        <div>
          <img src="static/img/search.png">
          <input v-model="hs_text" @focus="hs_focus" @blur="hs_blur" class="focus" type="text" placeholder="What do you like?">  
        </div>
        <img v-show="hs_isFocus" @click="del_hs_text" class="hs_del_text" src="static/img/login_del.png">
      </div>
      <span class="hs_cancle active">Cancle</span>
    </div>
